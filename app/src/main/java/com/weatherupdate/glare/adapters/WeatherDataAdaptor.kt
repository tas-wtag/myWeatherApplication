...
public class WeatherDataAdaptor extends ArrayAdapter<UpcomingWeatherData> {
    private Context context;
    ArrayList<UpcomingWeatherData> weatherdata;

    public WeatherDataAdaptor(@NonNull Context context, ArrayList<UpcomingWeatherData> weatherdata) {
